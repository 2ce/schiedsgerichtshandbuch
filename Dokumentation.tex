% \begin{refsection}
%\chapterpreamble{Dokumentiert (vgl. \S~14~SGO\indexPar{SGO!14@\S~14}) werden Verfahrensakten und Urteile.
...
%Werden während Verfahren Tonaufzeichnungen angefertigt, sind diese zu löschen, sobald die Parteien das daraus angefertigte Protokoll erhalten und einen Monat keinen Widerspruch erhoben haben, \S~14 Abs.~3~SGO\indexPar{SGO!14@\S~14!3@Abs.~3}.
%Die Verfahrensakte ist fünf Jahre nach Abschluss des Verfahrens aufzubewahren, Urteile unbefristet, \S~14~Abs.~5~SGO\indexPar{SGO!14@\S~14!5@Abs.~5}.}
\chapterpreamble{Sir~James~Norrington: \enquote{Ihr seid der schlechteste Pirat, von dem ich je gehört habe.}\\
Jack~Sparrow: \enquote{Aber Ihr habt von mir gehört!}\\
--~Fluch der Karibik (US, 2003)}
...
\label{Dokumentation}
Die Dokumentationspflichten der Schiedsgerichte sind in \S~14~SGO\indexPar{SGO!14@\S~14} geregelt.
Diese Dokumentation ist für den Gebrauch im Verfahren bestimmt; bezieht sich also auf die Verfahrensakte.
Dies dient einerseits dazu, das Verfahren zu erleichtern (vgl.\nomenclature{vgl.}{vergleiche} auch \S~10 Abs.~1 S.~3~SGO),\indexPar{SGO!10@\S~10!1@Abs.~1} andererseits auch zur Verwendung durch eine Rechtsmittelinstanz.
Darüber hinaus dient die Dokumentation auch dem längerfristigen Nachweis, \S~14 Abs.~5~SGO\indexPar{SGO!14@\S~14!5@Abs.~5}.

In \S~15~SGO\indexPar{SGO!15@\S~15} schließlich ist die Rechenschaftslegung nach außen geregelt.
Die Veröffentlichungsrechte und -pflichten sind die Begrenzung der ansonsten für die Mitglieder von Schiedsgerichten geltenden Verschwiegenheitspflicht (\S~2 Abs.~4~SGO).\indexPar{SGO!2@\S~2!4@Abs.~4}\index[idx]{Verschwiegenheitspflicht}
...
Der Umfang der Verfahrensakte wird von \S~14 Abs.~2~SGO\indexPar{SGO!14@\S~14!2@Abs.~2} definiert (\Zitat{Verlaufsprotokolle von Anhörungen und Verhandlungen, alle für das Verfahren relevanten Schriftstücke und das Urteil}).
Da es sich hierbei ausschließlich um Texte handelt -- von Tonaufzeichnungen sind Protokolle anzufertigen, \S~14 Abs.~3 S.~2~SGO\indexPar{SGO!14@\S~14!3@Abs.~3} -- empfiehlt es sich, die verschiedenen Quellen in eine einzelne Datei (bspw.\nomenclature{bspw.}{beispielsweise} im PDF\nomenclature{PDF}{Portable Document Format}) zusammenzufassen.

Als \enquote{Schriftstücke} i.S.d.\nomenclature{i.S.d.}{im Sinne der/des} \S~14 Abs.~2~SGO sind auch sämtliche Aktennotizen (z.B.\nomenclature{z.B.}{zum Beispiel} zu (fern-) mündlich gestellten Anträgen etc.\nomenclature{etc.}{et cetera} zu verstehen.
Nicht zur Akte gehören hingegen die Beratungen der Richter:
Da das Abstimmverhalten nicht mitzuteilen ist, \S~12 Abs.~3 S.~4~SGO\indexPar{SGO!12@\S~12!3@Abs.~3} und die Richter allgemein Verschwiegenheit zu wahren haben, \S~2 Abs.~4~SGO,\indexPar{SGO!2@\S~2!4@Abs.~4} sind auch Beratungen der Richter untereinander nicht Teil der Akte.
...
Die Verfahrensakte ist nach Abschluss des Verfahrens 5~Jahre aufzubewahren, \S~14 Abs.~5 S.~1~SGO.\indexPar{SGO!14@\S~14!5@Abs.~5}
Das ist auch elektronisch möglich, bspw. im ohnehin verwendeten Ticket-System oder als konsolidiertes PDF.

Die Akte ist gegen unbefugten Zugriff zu sichern; neben dem jeweils amtierenden Gericht haben nur die jeweiligen Verfahrensparteien das Recht auf Akteneinsicht, \S~14 Abs.~4~SGO.\indexPar{SGO!14@\S~14!4@Abs.~4}
...
Das wird bereits daran deutlich, dass im laufenden Verfahren die Parteien bereits aufgrund von \S~10 Abs.~1 S.~3~SGO\indexPar{SGO!10@\S~10!1@Abs.~1} Zugriff auf die Verfahrensakte erhalten.

Nach Ablauf der Aufbewahrungsfrist ist die Akte (mit Ausnahme des Urteils, \S~14 Abs.~5 S.~2~SGO),\indexPar{SGO!14@\S~14!5@Abs.~5} zu vernichten bzw. zu löschen.
...
Die Protokolle von Verhandlungen sind Teil der Verfahrensakte, \S~14 Abs.~2~SGO.\indexPar{SGO!14@\S~14!2@Abs.~2}
...
Hier bietet sich eine Veröffentlichung im Rahmen der regelmäßigen Berichtspflicht des Schiedsgerichts nach \S~15 Abs.~1~SGO\indexPar{SGO!15@\S~15!1@Abs.~1} und bzw.\nomenclature{bzw.}{beziehungsweise} oder im Arbeitsbericht an.
...
Gegen einen rechtsmittelfähigen Beschluss können die Beteiligten auch aus dem Verfahren heraus ein Rechtsmittel zur nächsten Instanz erheben (vgl. auch \S~13 Abs.~6~SGO).\indexPar{SGO!13@\S~13!6@Abs.~6}
Der einzige rechtsmittelfähige, aber gleichzeitig nicht auch das Verfahren (zmd. am jeweiligen  Gericht) beendende Beschluss ist der Beschluss, der die Ablehnung eines Richters durch eine Streitpartei für unbegründet erklärt, \S~5 Abs.~6 S.~2, 3~SGO.\indexPar{SGO!5@\S~5!6@Abs.~6}
...
Nicht anfechtbar sind bspw. die Eröffnung eines Verfahrens gemäß \SSS~8 Abs.~6 S.~1, 9 Abs.~1 S.~1~SGO,\indexPar{SGO!8@\S~8!6@Abs.~6}\indexPar{SGO!9@\S~9!1@Abs.~1} der Ausschluss eines Mitglieds des Spruchkörpers wegen der Besorgnis der Befangenheit (\S~5 Abs.~6 S.~1~SGO\indexPar{SGO!5@\S~5!6@Abs.~6}), sowie die Anordnungen der Schiedsgerichte zu Fristen, über Beweisanträge (vgl. \S~10 Abs.~1 S.~2~SGO)\indexPar{SGO!10@\S~10!2@Abs.~2} und alle sonstigen Beschlüsse, gegen die nicht explizit ein Rechtsmittel vorgesehen ist.\footnote{Vgl. \S~13 Abs.~6~SGO\indexPar{SGO!13@\S~13!6@Abs.~6}, ebenso \cite[5]{LSGBB147}.}
...
Soweit eine Veröffentlichung erfolgt, wäre prinzipiell die fünfjährige Aufbewahrungsfrist nach \S~14 Abs.~5 S.~1~SGO\indexPar{SGO!14@\S~14!5@Abs.~5} einschlägig.
...
Eine unbegrenzte Aufbewahrung entsprechend den Urteilen (\S~14 Abs.~5 S.~2~SGO\indexPar{SGO!14@\S~14!5@Abs.~5}) ist dann zulässig, da insbesondere rechtliche Erwägungen für die Parteiöffentlichkeit relevant sind.
...
Dies sind:
\begin{enumerate}
\item Die Übertragung eines Verfahrens an den Senat des Bundesschiedsgerichts, \S~3 Abs.~11 S.~7~SGO,\indexPar{SGO!3@\S~3!11@Abs.~11}
\item die Verweisung eines Verfahrens wegen Handlungsunfähigkeit des Gerichts, \S~6 Abs.~5~SGO,\indexPar{SGO!6@\S~6!5@Abs.~5}
\item die Übernahme eines Verfahrens durch das Obergericht wegen Verfahrensverzögerung, \S~10 Abs.~9 S.~5~SGO,\indexPar{SGO!10@\S~10!9@Abs.~9}
\item die Ablehnung der Verfahrenseröffnung (Nichteröffnung),\index[idx]{Nichteröffnung} \S~8 Abs.~6~SGO,\indexPar{SGO!8@\S~8!6@Abs.~6}
\item Erlass oder Ablehnung einer einstweiligen Anordnung (da hiermit das Verfahren im einstweiligen Rechtsschutz zunächst beendet wird), \S~11 Abs.~1, 7~SGO.\indexPar{SGO!11@\S~11!1@Abs.~1}\indexPar{SGO!11@\S~11!7@Abs.~7}
\end{enumerate}

Es ist naheliegend, diese Beschlüsse aufgrund ihrer verfahrensbeendenden Wirkung wie Urteile zu behandeln und die auf Urteile anzuwendenden Vorschriften ebenfalls (ggf. analog) anzuwenden.\footnote{In Bezug auf einstweilige Anordnungen ist dies bereits durch die SGO vorgeschrieben, \S~11 Abs.~7~SGO.\indexPar{SGO!11@\S~11!7@Abs.~7}}
...
Diese Originalfassung muss in Papierform vorliegen (\Zitat{schriftlich}, \Zitat{von allen Richtern unterschrieben}, \S~12 Abs.~7~SGO\indexPar{SGO!12@\S~12!7@Abs.~7}) und darf keine Schwärzungen enthalten.
Für sie gelten daher besondere Aufbewahrungsbestimmungen (vgl.~\ref{Dokumentation:Aufbewahrung}).

Anders verhält es sich mit der für die Veröffentlichung bestimmte (\S~12 Abs.~8~SGO)\indexPar{SGO!12@\S~12!8@Abs.~8} Fassung.
...
Ist das Verfahren öffentlich, so wird das Urteil insgesamt veröffentlicht, \S~12 Abs.~8 S.~1~SGO.\indexPar{SGO!12@\S~12!8@Abs.~8}
...
Pseudonymisieren ist das Ersetzen des Namens und anderer Identifikationsmerkmale durch ein Kennzeichen zu dem Zweck, die Bestimmung des Betroffenen auszuschließen oder wesentlich zu erschweren (\S~3 Abs.~6a~BDSG).\indexPar{BDSG!3@\S~3!6a@Abs.~6a}\nomenclature{BDSG}{Bundesdatenschutzgesetz}
...
Ausdrücklich ausgenommen von der Pseudonymisierungspflicht sind gemäß \S~12 Abs.~8 S.~2~SGO\indexPar{SGO!12@\S~12!8@Abs.~8} lediglich die Namen von Gliederungen und die Namen der Richter in ihrer Funktion.
...
Ist das Verfahren nichtöffentlich, so wird lediglich der Tenor veröffentlicht, \S~12 Abs.~8 S.~3~SGO.\indexPar{SGO!12@\S~12!8@Abs.~8}
Die Bestimmung ist -- auch in Ansehung der Formulierung des \S~12 Abs.~3 S.~1~SGO\indexPar{SGO!12@\S~12!Abs.~3} -- dergestalt auszulegen, dass das Rubrum zum \enquote{Tenor} gehört (vgl.~\ref{Urteilsaufbau:Rubrum}~f.).\index[idx]{Tenor}
...
Der Beschluss zum Nichtöffentlichen Verfahren ist in diesen Fällen eine gebundene Entscheidung, \S~10 Abs.~7 S.~2~SGO.\indexPar{SGO!10@\S~10!7@Abs.~7}
Insbesondere, da auf diese Möglichkeit im Eröffnungsbeschluss hinzuweisen ist, \S~9 Abs.~4 S.~1~SGO,\indexPar{SGO!9@\S~9!4@Abs.~4} sind viele Ordnungsmaßnahmeverfahren nichtöffentlich.
...
Gemäß \S~2 Abs.~5~SGO\indexPar{SGO!2@\S~2!5@Abs.~5} sind die Schiedsgerichte verpflichtet, Versuche der Beeinflussung eines Verfahrens öffentlich bekannt zu machen.
Was eine Beeinflussung ist, liegt letztlich im Ermessen des Schiedsgerichts.
Insbesondere der Versuch, dem Schiedsgericht Weisungen zu erteilen (im Innenverhältnis der Partei durch \S~2 Abs.~2~SGO,\indexPar{SGO!2@\S~2!2@Abs.~2} im Außenverhältnis durch \S~14 Abs.~2 S.~4~PartG\indexPar{PartG!14@\S~14!2@Abs.~2} verboten) stellt eine solche veröffentlichungspflichtige Tatsache dar.
...
Das Gericht kann zu laufenden Verfahren öffentliche Stellungnahmen abgeben, \S~15 Abs.~2 S.~1~SGO.\indexPar{SGO!15@\S~15!2@Abs.~2}
Voraussetzung dafür ist, dass das Verfahren öffentlich ist (\S~15 Abs.2 S.~2~SGO)\indexPar{SGO!15@\S~15!2@Abs.~2} und dass das Schiedsgericht ein erhebliches parteiöffentliches Interesse feststellt.
...
Stellungnahmen sind als \enquote{relevantes Schriftstück} i.S.d. \S~14 Abs.~2~SGO\indexPar{SGO!14@\S~14!2@Abs.~2} zugleich Teil der Verfahrensakte.\index[idx]{Akte!Inhalt}
...
Die Aufbewahrung der Akten bestimmt sich nach der Geschäftsordnung des Schiedsgerichts, \S~2 Abs.~6 S.~2~SGO.\indexPar{SGO!2@\S~2!6@Abs.~6}
...
Nach Ablauf der fünfjährigen Aufbewahrungsfrist (\S~14 Abs.~5~SGO)\indexPar{SGO!14@\S~14!5@Abs.~5} ist die Akte an all ihren Speicherorten zu vernichten.

\subsubsection{Urteile}
Urteile sind unbefristet aufzubewahren, \S~14 Abs.~5 S.~2~SGO.\indexPar{SGO!14@\S~14!5@Abs.~5}
Dies bezieht sich insbesondere auf die schriftliche, von allen (am Verfahren beteiligten) Richtern unterschriebene Originalfassung nach \S~12 Abs.~7~SGO.\indexPar{SGO!12@\S~12!7@Abs.~7}
...
Auch der Zugang zu sonstigen Akten des Gerichts ist grundsätzlich zu beschränken, da sie von der Verschwiegenheitspflicht aus \S~2 Abs.~4~SGO\indexPar{SGO!2@\S~2!4@Abs.~4} umfasst sind.
...
Das Gericht soll während der Amtszeit regelmäßig berichten; gemäß \S~15 Abs.~1~SGO\indexPar{SGO!15@\S~15!1@Abs.~1} insbesondere über die Zahl der Fälle.
Allerdings hat das Gericht auch Urteile zu veröffentlichen, \S~12 Abs.~8 S.~1~SGO.\indexPar{SGO!12@\S~12!8@Abs.~8}
...
Gemäß \S~15 Abs.~3~SGO\indexPar{SGO!15@\S~15!3@Abs.~3} soll er die Fälle der Amtsperiode inklusive der jeweiligen Urteile kurz darstellen.
...
Zwar sind nichtöffentliche Verfahren auch vom Gericht vertraulich zu behandeln, \S~9 Abs.~4 S.~2~SGO.\indexPar{SGO!9@\S~9!4@Abs.~4}
Das Urteil darf nur eingeschränkt veröffentlicht werden, \S~12 Abs.~8 S.~4~SGO,\indexPar{SGO!12@\S~12!8@Abs.~8} und öffentliche Stellungnahmen sind vollständig unzulässig, \S~15 Abs.~2 S.~2~SGO.\indexPar{SGO!15@\S~15!2@Abs.~2}
Demgegenüber sollen aber alle Fälle der Amtsperiode im Arbeitsbericht kurz dargestellt werden, \S~15 Abs.~3~SGO.\indexPar{SGO!15@\S~15!3@Abs.~3}
