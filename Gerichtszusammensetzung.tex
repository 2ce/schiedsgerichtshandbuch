\chapterpreamble{Innerhalb des Organs „Schiedsgericht“, das sich zusammensetzt aus den gewählten Richtern und Ersatzrichtern, stellen die mit dem jeweiligen Verfahren befassten Richter das (entscheidende) „Schiedsgericht“ dar.
Die genaue Zusammensetzung ergibt sich aus der Eigenschaft als Schiedsrichter oder (im Fall von Kammersystemen) aus der Geschäftsordnung.
Die Zusammensetzung muss von vorn herein feststehen und darf nicht willkürlich verändert werden.
Ein einmal befasster Richter kann regelmäßig nur durch Ausschluss aus dem konkreten Verfahren (typischerweise wegen Besorgnis der Befangenheit), generelle Beurlaubung oder Rücktritt vom Amt aus einem Verfahren ausscheiden.
Ein temporäres Ausscheiden und spätere Wiederbefassung kommt ebensowenig in Betracht wie eine Rücktritt nur für ein einzelnes Verfahren.
Ablehnungsanträge (Anträge auf Feststellung der Besorgnis der Befangenheit) müssen sich immer gegen jeweils eine konkrete Person richten und müssen einzeln (im Zweifel in der zeitlichen Reihenfolge der Antragstellung) entschieden werden.
Näheres legt \S~5~SGO\index[paridx]{SGO!5@\S~5} fest.}
...
Dementsprechend haben die Satzungen der Piratenparteien und ihrer Untergliederungen das Schiedsgericht typischerweise auch als Organ bezeichnet.\footnote{\S~9 Abs.~2~BS,\index[paridx]{BS!9@\S~9!2@Abs.~2} \S~9 Abs.~1~LS-BW,\index[paridx]{LS-BW!9@\S~9!2@Abs.~2} \S~9 Abs.~1~LS-BY,\index[paridx]{LS-BY!9@\S~9!1@Abs.~1} \S~7 Abs.~1~LS-BB,\index[paridx]{LS-BB!7@\S~7!1@Abs.~1} \S~10~LS-HB\index[paridx]{LS-HB!10@\S~10} \S~8 Nr.~1~c~LS-HH,\index[paridx]{LS-HH!8@\S~8} \S~9 Abs.~1~LS-HE\index[paridx]{LS-HE!9@\S~9!1@Abs.~1} \S~9~LS-MV,\index[paridx]{LS-MV!9@\S~9} \S~6~LS-NW,\index[paridx]{LS-NW!6@\S~6} \S~4~LS-RP,\index[paridx]{LS-RP!4@\S~4} \S~9 Abs.~1~LS-SL,\index[paridx]{LS-SL!9@\S~9!1@Abs.~1} \S~6 Abs.~1~LS-SN,\index[paridx]{LS-SN!6@\S~6!1@Abs.~1} \S~9 Abs.~1~LS-ST,\index[paridx]{LS-ST!9@\S~9!1@Abs.~1} \S~9 Abs.~1~LS-SH,\index[paridx]{LS-SH!9@\S~9!1@Abs.~1} \S~6 Abs.~1~LS-TH;\index[paridx]{LS-TH!6@\S~6!1@Abs.~1} lediglich die LS-BE, als auch die LS-NI schweigen zum Status.}
...
Auch etwa gemeinsam formulierte Standardsschreiben, die Zuständigkeiten für die Verwaltung der Dokumentation nach \S~14 SGO\index[paridx]{SGO!14@\S~14} und sämtliche sonstigen, nicht auf konkrete Verfahren oder Anrufungen bezogenen Tätigkeiten werden von dem gesamten Organ entschieden.
...
Das Schiedgericht im Sinne des entscheidenen Spruchkörpers\index[idx]{Spruchkörper|textbf} für konkrete Verfahren setzt sich dahingegen nach \SSS~3--5 SGO\index[paridx]{SGO!3@\S~3}\index[paridx]{SGO!4@\S~4}\index[paridx]{SGO!5@\S~5} zusammen. Dabei ist im Folgenden mit Schiedsgericht nicht mehr das Organ, sondern der Spruchkörper für eine konkrete Anrufung gemeint.
...
Dies liegt daran, dass Art.~101 Abs.~2 Satz~2 GG\index[paridx]{GG!101@Art.~101!2@Abs.~2} jedermann das Recht auf den \emph{gesetzlichen Richter} garantiert.
...
Dieser akademische Streit um die Auslegung des \S~14 PartG\index[paridx]{PartG!14@\S~14} ist jedoch für Verfahren in der Schiedsgerichtsbarkeit der Piratenpartei Deutschland nicht relevant.
...
Die Regelung ist an dabei die staatlichen Prozessordnungen angelehnt.\footnote{Vgl. etwa \S~41 ZPO\index[paridx]{ZPO!41@\S~41},  \S~22 StPO\index[paridx]{StPO!22@\S~22}\nomenclature{StPO}{Strafprozessordnung}, \S~54 VwGO\index[paridx]{VwGO!54@\S~54}\nomenclature{VwGO}{Verwaltungsgerichtsordnung}, \S~51 FGO\index[paridx]{FGO!51@\S~51}\nomenclature{FGO}{Finanzgerichtsordnung}, \S~60 SGG\index[paridx]{SGG!60@\S~60}\nomenclature{SGG}{Sozialgerichtsgesetz} und \S~19 BVerfGG\index[paridx]{BVerfGG!19@\S~19}\nomenclature{BVerfGG}{Bundesverfassungsgerichtsgesetz}.}
