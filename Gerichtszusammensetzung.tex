\chapterpreamble{\enquote{Was also ist [\dots] \enquote{Befangenheit}? Gewiss nicht schon eine allgemeine Vorstellung davon, was, bezogen auf eine Rechtsfrage, \enquote{richtig} ist.} --- Prof. Dr. Thomas Fischer, Vorsitzender Richter am Bundesgerichtshof.}
...
Das Schiedsgericht ist zwar kein Organ\index[idx]{Organ} im Sinne des \S~8 Abs.~2 PartG\indexPar{PartG!8@\S~8!2@Abs.~2}\footnote{\cite[\S~14 Rn.~3]{ipsen2008parteiengesetz}}, da es nicht der originiären politischen Willensbildung der Partei dient, allerdings ist es grundsätzlich ein Organ im weiteren Sinne.
Dementsprechend haben die Satzungen der Piratenparteien und ihrer Untergliederungen das Schiedsgericht typischerweise auch als Organ bezeichnet.\footnote{\S~9 Abs.~2~BS,\indexPar{BS!9@\S~9!2@Abs.~2} \S~9 Abs.~1~LS-BW,\indexPar{LS-BW!9@\S~9!2@Abs.~2} \S~9 Abs.~1~LS-BY,\indexPar{LS-BY!9@\S~9!1@Abs.~1} \S~7 Abs.~1~LS-BB,\indexPar{LS-BB!7@\S~7!1@Abs.~1} \S~10~LS-HB\indexPar{LS-HB!10@\S~10} \S~8 Nr.~1~c~LS-HH,\indexPar{LS-HH!8@\S~8} \S~9 Abs.~1~LS-HE\indexPar{LS-HE!9@\S~9!1@Abs.~1} \S~9~LS-MV,\indexPar{LS-MV!9@\S~9} \S~6~LS-NW,\indexPar{LS-NW!6@\S~6} \S~4~LS-RP,\indexPar{LS-RP!4@\S~4} \S~9 Abs.~1~LS-SL,\indexPar{LS-SL!9@\S~9!1@Abs.~1} \S~6 Abs.~1~LS-SN,\indexPar{LS-SN!6@\S~6!1@Abs.~1} \S~9 Abs.~1~LS-ST,\indexPar{LS-ST!9@\S~9!1@Abs.~1} \S~9 Abs.~1~LS-SH,\indexPar{LS-SH!9@\S~9!1@Abs.~1} \S~6 Abs.~1~LS-TH;\indexPar{LS-TH!6@\S~6!1@Abs.~1} lediglich die LS-BE, als auch die LS-NI schweigen zum Status.}
\nomenclature{LS-BW}{Landessatzung Baden-Württemberg} \nomenclature{LS-BY}{Landessatzung Bayern} \nomenclature{LS-BB}{Landessatzung Brandenburg} \nomenclature{LS-BE}{Landessatzung Berlin} \nomenclature{LS-HB}{Landessatzung Bremen} \nomenclature{LS-HH}{Landessatzung Hamburg} \nomenclature{LS-HE}{Landessatzung Hessen} \nomenclature{LS-MV}{Landessatzung Mecklenburg-Vorpommern} \nomenclature{LS-NI}{Landessatzung Niedersachsen} \nomenclature{LS-NW}{Landessatzung Nordrhein-Westfalen} \nomenclature{LS-RP}{Landessatzung Rheinland-Pfalz} \nomenclature{LS-SL}{Landessatzung Saarland} \nomenclature{LS-SN}{Landessatzung Sachsen} \nomenclature{LS-ST}{Landessatzung Sachsen-Anhalt} \nomenclature{LS-TH}{Landessatzung Thüringen} \nomenclature{LS-SH}{Landessatzung Schleswig-Holstein}
...
Dazu gehören etwa der Beschluss der Geschäftsordnung\index[idx]{Geschäftsordnung} nach \S~2 Abs.~6 SGO\indexPar{SGO!2@\S~2!6@Abs.~6} empfiehlt.
Auch etwa gemeinsam formulierte Standardsschreiben, die Zuständigkeiten für die Verwaltung der Dokumentation nach \S~14 SGO\indexPar{SGO!14@\S~14} und sämtliche sonstigen, nicht auf konkrete Verfahren oder Anrufungen bezogenen Tätigkeiten werden von dem gesamten Organ entschieden.
Nicht dazu gehört allerdings die Wahl des Vorsitzenden Richters.
Die Schiedsgerichtsordnung hat diese in \S~3 Abs.~1 Satz~2 SGO\indexPar{SGO!3@\S~3!1@Abs.~1} allein in die Hände der Richter gelegt, die Ersatzrichter haben hierbei weder aktives noch passives Wahlrecht.

\section{Das Schiedsgericht als Spruchkörper}
\label{Zusammensetzung:Spruchkoerper}
Das Schiedgericht im Sinne des entscheidenen Spruchkörpers\index[idx]{Spruchkörper|textbf} für konkrete Verfahren setzt sich dahingegen nach \SSS~3--5 SGO\indexPar{SGO!3@\S~3}\indexPar{SGO!4@\S~4}\indexPar{SGO!5@\S~5} zusammen. Dabei ist im Folgenden mit Schiedsgericht nicht mehr das Organ, sondern der Spruchkörper für eine konkrete Anrufung gemeint.
...
Sobald einer dieser Richter sein Amt gemäß \S~3 Abs.~7, 8 SGO\indexPar{SGO!3@\S~3!7@Abs.~7} verliert, rückt ein Ersatzrichter dauerhaft nach und wird Teil des standardmäßigen Spruchkörpers.
...
Dies ist einerseits schon durch das Wort \enquote{dauerhaft} nahegelegt, dass es einen rechtlichen Unterschied zum nur temporären Einrücken in ein einzelnes Verfahren nach \S~4 Abs.~4 SGO\indexPar{SGO!4@\S~4!4@Abs.~4} erlaubten erhöhten Ersatzrichterzahl sogar zu einer Situation kommen könne, in der kein verbleibendes Mitglied des Schiedsgerichts aktives oder passives Wahlrecht für die Wahl des Vorsitzenden Richters hätte.
...
Dies liegt daran, dass Art.~101 Abs.~2 Satz~2 GG\indexPar{GG!101@Art.~101!2@Abs.~2} jedermann das Recht auf den \emph{gesetzlichen Richter} garantiert.
...
\begin{enumerate}
\item Ausschluss wegen Untätigkeit eines einzelnen Richters, \S~4 Abs.~1 SGO.\indexPar{SGO!4@\S~4!1@Abs.~1}
\item Ausschluss wegen Krankheit, \S~4 Abs.~3 Satz~1 Alt.~1 SGO.\indexPar{SGO!4@\S~4!3@Abs.~3}
\item Ausschluss wegen Beurlaubung, \S~4 Abs.~3 Satz~1 Alt.~2 SGO.\indexPar{SGO!4@\S~4!3@Abs.~3}
\item Ausschluss wegen Besorgnis der Befangenheit, \S~5 Abs.~2 Satz 1 Alt.~1, Satz~2 SGO.\indexPar{SGO!5@\S~5!2@Abs.~2}
\item Ausschluss wegen satzungsmäßig unwiderlegbar vermuteter Befangenheit, \S~5 Abs.~1 SGO.\indexPar{SGO!5@\S~5!1@Abs.~1}
\end{enumerate}
...
\S~4 Abs.~4 Satz~2 Alt.~2 SGO\indexPar{SGO!4@\S~4!4@Abs.~4} sagt lediglich aus, dass die Beschlussfähigkeit auch mit zwei Richtern gegeben ist.
Aus dem Grundsatz, dass niemand Richter in eigener Sache sein darf,\footnote{lat.: \emph{nemo iudex in sua causa}.} folgt schon, dass der betroffene Richter selbst nicht mitentscheiden darf. Für die Fälle des \S~5 SGO\indexPar{SGO!5@\S~5} ist das auch ausdrücklich in der Schiedsgerichtsordnung niedergelegt, aber auch in den anderen Fällen muss dieser Grundsatz gelten.
In Betracht kommen daher zwei denkbare Besetzungen: Die verbleibenden Richter der bisherigen Spruchkörperbesetzung entscheiden über den Ausschluss des Richters oder aber \S~4 Abs.~2 Satz~1 SGO\indexPar{SGO!4@\S~4!2@Abs.~2} nicht nur die schon per Beschluss ausgeschlossenen Richter umfasst, sondern auch die, über die konkret beschieden werden soll.
...
Sie ist dann geboten, wenn anders kein Fortschritt im Verfahren erzielt werden kann oder weiteres Abwarten die Einhaltung der Verfahrensmaximalsolldauer nach \S~12 Abs.~1 SGO\indexPar{SGO!12@\S~12!1@Abs.~1} gefährdet.

\subsection{Änderung durch Ausschluss eines Richters wegen Krankheit}
\label{Zusammensetzung:Spruchkoerper:Krankheit}
Der Ausschluss eines Richters wegen Krankheit gemäß \S~4 Abs.~3 Satz~1 Alt.~1 SGO\indexPar{SGO!4@\S~4!3@Abs.~3} ist etwas anders geartet.
...
In die selbe Kategorie wie der Ausschluss eines Richters wegen Krankheit fällt der Ausschluss eines Richters wegen Beurlaubung gemäß \S~4 Abs.~3 Satz~1 Alt.~2 SGO.\indexPar{SGO!4@\S~4!3@Abs.~3}
...
Das Parteiengesetz fordert in \S~14 Abs.~4\indexPar{PartG!14@\S~14!4@Abs.~4} lediglich, dass jede Streitpartei Richter wegen Befangenheit ablehnen kann.
...
Dieser akademische Streit um die Auslegung des \S~14 PartG\indexPar{PartG!14@\S~14} ist jedoch für Verfahren in der Schiedsgerichtsbarkeit der Piratenpartei Deutschland nicht relevant.
Dies Schiedsgerichtsordnung garantiert in \S~5 Abs.~2 SGO\indexPar{SGO!5@\S~5!2@Abs.~2} ein Recht auf Ablehnung eines jeden Richters bei Besorgnis seiner Befangenheit.
...
Der Antrag muss immer eine Begründung enthalten, \S~5 Abs.~3 Satz~1 SGO\indexPar{SGO!5@\S~5!3@Abs.~3}, und sich gegen einene einzelnen Richter richten, andernfalls ist er unzulässig.\footnote{\cites[S.~1]{BSG201305062BefangenheitI}{BGHIIARZ101}.}\nomenclature{BGH}{Bundesgerichtshof}
...
Ein unzulässiger Ablehnungsantrag wird entgegen \S~5 Abs.~5 SGO\indexPar{SGO!5@\S~5!5@Abs.~5} in originaler, ungeänderter Besetzung beschieden, da schon gar kein formal korrekter Befangenheitsantrag im Sinne des \S~5 Abs.~5 SGO\indexPar{SGO!5@\S~5!5@Abs.~5} vorliegt.\footnote{\cites[S.~1]{BSG201305062BefangenheitI}{BSG201305062BefangenheitII}.}

Sobald ein zulässiger Ablehnungantrag gegen einen Richter gestellt ist, darf dieser nicht mehr an verfahrensleitenden Entscheidungen teilnehmen, bis der Antrag abgelehnt wurde oder angnommen wurde, \S~5 Abs.~4 SGO.\indexPar{SGO!5@\S~5!4@Abs.~4}
Im letzten Fall ist mit Beschluss aus dem Verfahren ausgeschieden und wird durch den nächsten Ersatzrichter ersetzt, \S~4 Abs.~2 SGO.\indexPar{SGO!4@\S~4!2@Abs.~2}
...
Beiden Parteien daraufhin noch eine Gelegenheit zur Stellungnahme zu geben, \S~5 Abs.~3 Satz~2 SGO\indexPar{SGO!5@\S~5!3@Abs.~3}, danach kann in geänderter Besetzung nach \SSS~5 Abs.~5, 4 Abs.~2 SGO\indexPar{SGO!5@\S~5!5@Abs.~5}\indexPar{SGO!4@\S~4!2@Abs.~2} über den Befangenheitsantrag beschieden werden.
...
Für den Beschluss, ob ein Richter im Verfahren bleibt, oder wegen Besorgnis der Befangenheit aus dem Verfahren ausscheidet, muss entschieden werden, ob ein neutraler, objektiver, fiktiver Dritter, der in Kenntnis der Tatsachen zu entscheiden hätte, einen gerechtfertigten Grund hätte, an dem Unparteilichkeit des Richters zu zweifeln, \S~5 Abs.~2 Satz~2.\indexPar{SGO!5@\S~5!2@Abs.~2}
...
Dies ist eine wertende Entscheidung und nicht eine bloße Formalentscheidung und muss daher in der geänderten Besetzung nach \SSS~5 Abs.~5, 4 Abs.~2 SGO\indexPar{SGO!5@\S~5!5@Abs.~5}\indexPar{SGO!4@\S~4!2@Abs.~2} beschieden werden.
...
Ein Richter kann durch eine Streitpartei nach \S~5 Abs.~2 Satz~1 Alt.~2, Abs.~1 SGO\indexPar{SGO!5@\S~5!2@Abs.~2} abgelehnt werden.
Die Möglichkeit, dass die Streitparteien einen solchen Antrag stellen können, darf aber nicht über die Natur des \S~5 Abs.~1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} täuschen.
Es handelt sich hier um eine Vorschrift, die von Amts wegen von jedem Gericht gerpüft werden muss, bevor ein Richter an einem Verfahren teilnehmen kann.\footnote{So auch schon \cite{BSGPP100127862}, daher die dortige Vorabprüfung.} \S~5 Abs.~1 Satz~1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} stellt verschiedene objektive Bedingungen auf, die ohne wertenden Ermessenspielraum verbieten, dass ein Richter sein Amt in einem Verfahren ausübt.

\subsubsection{Prozessual Grundlegendes}
\label{Zusammensetzung:Spruchkoerper:Befangenheitsvermutung:Prozessuales}
\S~5 Abs.~1 Satz~2 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} fordert lediglich, dass ohne den betroffenen Richter beschieden wird.
Insofern rückt der in der Rangfolge nächste Ersatzrichter für diese Entscheidung in den Spruchkörper ein und die Parteien sind davon in Kenntnis zu setzen, \S~4 Abs.~2 S.~2 SGO.\indexPar{SGO!4@\S~4!2@Abs.~2}
...
Anders könnte es aussehen, wenn eine Streitpartei die Entscheidung darüber nach \S~5 Abs.~2 Satz~1 Alt.~2 SGO\indexPar{SGO!5@\S~5!2@Abs.~2} beantragt hat.
Denn dem Wortlaut der Schiedsgerichtsordnung nach treffen die prozessualen Vorschriften des \S~5 Abs.~2 ff. SGO\indexPar{SGO!5@\S~5!2@Abs.~2}
...
Daher müssen die Prozessvorschriften des \S~5 Abs.~2 ff. SGO\indexPar{SGO!5@\S~5!2@Abs.~2} einzeln geprüft werden, ob sie auf die Eigenheiten der Richterablehnung wegen satzungsmäßigem Ausschlussgrund anwendbar sind oder nicht.
...
Richter sind gemäß \S~5 Abs.~2 Satz~3 SGO\indexPar{SGO!5@\S~5!2@Abs.~2} verpflichtet, jeden Umstand dem Spruchkörper und den Streitparteien anzuzeigen, die einen Antrag auf Ablehnung begründen könnten.
Der Konjunktiv der Formulierung gebietet daher eine solche Anzeige auch schon, wenn der Richter überzeugt ist, dass kein Tatbestand des \S~5 Abs.~1 Satz~1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} erfüllt ist, eine solche Erfüllung aber denkbar wäre.
Diese Anzeigepflicht muss gerade und insbesondere für die abschließende Liste der klar umrissenen Tatbestände des \S~5 Abs.~1 Satz~1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} gelten.
Die Anzeige löst auch sofort eine Bescheidungspflicht durch die anderen Richter nach \S~5 Abs.~1 Satz~2 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} aus, eines Antrags einer Partei bedarf es dann nicht mehr.

\subsubsection{Anwendung der Präklusionsregelung}
\label{Zusammensetzung:Spruchkoerper:Befangenheitsvermutung:Praeklusion}
\S~5 Abs.~2 Satz~4 SGO\indexPar{SGO!5@\S~5!2@Abs.~2} präkludiert Streitparteien davon, einen Richter abzulehnen, wenn der Grund für die Ablehnung schon ihr bekannt war und sie sich dennoch auf eine Verhandlung mit dem Richter eingelassen hat.
...
Auch müsste das Gericht, sobald es Kenntnis von der Möglichkeit eines satzungsmäßigen Ausschlussgrundes nach \S~5 Abs.~1 Satz~1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} hat, von Amts wegen über den Ausschluss entscheiden.
...
Das Begründungsgebot aus \S~5 Abs.~3 Satz~1 SGO\indexPar{SGO!5@\S~5!3@Abs.~3} ist unproblematisch anwendbar.
Wenn eine Partei der Ansicht ist, dass einer der Tatbestände aus \S~5 Abs.~1 Satz~1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} zutrifft, muss sie auch ausführen, welcher das ist und warum er zutrifft.
...
Jeder der Tatbestände des \S~5 Abs.~1 Satz~1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} stellt eine satzungsmäßige, unwiderlegliche Vermutung der Befangenheit des Betroffenen Richters auf.
...
Die Regelung ist an dabei die staatlichen Prozessordnungen angelehnt.\footnote{Vgl. etwa \S~41 ZPO\indexPar{ZPO!41@\S~41},  \S~22 StPO\indexPar{StPO!22@\S~22}\nomenclature{StPO}{Strafprozessordnung}, \S~54 VwGO\indexPar{VwGO!54@\S~54}\nomenclature{VwGO}{Verwaltungsgerichtsordnung}, \S~51 FGO\indexPar{FGO!51@\S~51}\nomenclature{FGO}{Finanzgerichtsordnung}, \S~60 SGG\indexPar{SGG!60@\S~60}\nomenclature{SGG}{Sozialgerichtsgesetz} und \S~19 BVerfGG\indexPar{BVerfGG!19@\S~19}\nomenclature{BVerfGG}{Bundesverfassungsgerichtsgesetz}.}
Diese Regelungen kommen aufgrund der vom Satzungsgeber getätigten Regelung in \S~5 Abs.~1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} nicht in Betracht für eine analoge Anwendung.
\S~14 Abs.~4 PartG\indexPar{PartG!14@\S~14!4@Abs.~4} fordert explizit vom Satzungsgeber, dass er die Richterablehnung selbst regeln muss.
...
Die Tatbestände des \S~5 Abs.~1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} gliedern sich in drei Gruppen (Nr.~1--5, Nr.~6--7, Nr.~8).
...
\subsubsection{Tatbestand \S~5 Abs.~1 Satz~1 Nr.~1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1}}
\label{Zusammensetzung:Spruchkoerper:Befangenheitsvermutung:Nr1}
\S~5 Abs.~1 Satz~1 Nr.~1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1}
...
\subsubsection{Tatbestand \S~5 Abs.~1 Satz~1 Nr.~2 SGO\indexPar{SGO!5@\S~5!1@Abs.~1}}
\label{Zusammensetzung:Spruchkoerper:Befangenheitsvermutung:Nr2}
\S~5 Abs.~1 Satz~1 Nr.~2 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} vermutet unwiderleglich, dass ein Richter, dessen Ehe- oder Lebenspartner Verfahrensrenspartei ist, befangen ist.
...
Es wäre einem Richter, der verpflichtet ist, das Erfülltsein des Tatbestandes nach \S~5 Abs.~2 Satz~3 SGO\indexPar{SGO!5@\S~5!2@Abs.~2} offenzulegen, auch nicht zuzumuten, jegliche frühere Beziehung in seinem Leben in einem Verfahren offenzulegen, wenn keinerlei sonstiger Bezug zum konkreten Verfahren besteht.
...
\subsubsection{Tatbestand \S~5 Abs.~1 Satz~1 Nr.~3 SGO\indexPar{SGO!5@\S~5!1@Abs.~1}}
\label{Zusammensetzung:Spruchkoerper:Befangenheitsvermutung:Nr3}
\S~5 Abs.~1 Satz~1 Nr.~3 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} Verfahrenspartei ist, befangen ist.
...
\subsubsection{Tatbestand \S~5 Abs.~1 Satz~1 Nr.~4 SGO\indexPar{SGO!5@\S~5!1@Abs.~1}}
\label{Zusammensetzung:Spruchkoerper:Befangenheitsvermutung:Nr4}
\S~5 Abs.~1 Satz~1 Nr.~4 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} vermutet unwiderleglich, dass ein Richter unwiderleglich als befangen gilt, wenn eine der Personen nach Nr.~1--3 einem Organ angehören, dass Streitpartei ist.
...
Das Bundesschiedsgericht hat in seinen Entscheidungen\footnote{\cite{BSGPP100127862},\cite{BSGPP100276262}.} zu ebendiesem Tatbestand entschieden, dass nur Organe der \enquote{Exekutive} erfasst seien, und damit gerade der Parteitag und somit auch die Grundsversammlung als satzungsgebendes (oder auch: rechtsetzendes) Organ und somit Organ der \enquote{Legislative} schon gar nicht erfasst wäre.
...
Damit verstößt \S~5 Abs.~1 Satz~1 Nr.~4, 1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} in diesen Konstellationen gegen höherrangiges Recht und darf zumindest in diesen Fällen nicht angewendet werden.
Sobald es um Parteitage niederer Gliederungen geht, und kein entsprechendes Schiedsgericht existiert, trifft diese geschilderte Konstellation nicht zu, in diesen Fällen ist \S~5 Abs.~1 Satz~1 Nr.~4, 1 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} daher anwendbar.


\subsubsection{Tatbestand \S~5 Abs.~1 Satz~1 Nr.~5 SGO\indexPar{SGO!5@\S~5!1@Abs.~1}}
\label{Zusammensetzung:Spruchkoerper:Befangenheitsvermutung:Nr5}
\S~5 Abs.~1 Satz~1 Nr.~5 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} vermutet unwiderleglich, dass ein Richter, der selbst eine Prozessvertreter oder gesetzlicher Vertreter einer Verfahrenspartei ist, befangen ist.
...
\subsubsection{Tatbestand \S~5 Abs.~1 Satz~1 Nr.~6 SGO\indexPar{SGO!5@\S~5!1@Abs.~1}}
\label{Zusammensetzung:Spruchkoerper:Befangenheitsvermutung:Nr6}
\S~5 Abs.~1 Satz~1 Nr.~6 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} vermutet unwiderleglich, dass ein Richter, der  Zeuge oder Sachverständiger in einem Verfahren ist, in diesem Verfahren befangen ist.
...
\subsubsection{Tatbestand \S~5 Abs.~1 Satz~1 Nr.~8 SGO\indexPar{SGO!5@\S~5!1@Abs.~1}}
\label{Zusammensetzung:Spruchkoerper:Befangenheitsvermutung:Nr8}
\S~5 Abs.~1 Satz~1 Nr.~8 SGO\indexPar{SGO!5@\S~5!1@Abs.~1} vermutet unwiderleglich, dass ein Richter, der als Schlichter in einem Verfahren aktiv war, nicht auch Richter sein soll.
