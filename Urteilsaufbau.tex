...
Ist die Rechtsmittelbelehrung unterblieben, so beginnt die Rechtsmittelfrist nicht zu laufen, \S~13 Abs.~2 S.~3~SGO\index[paridx]{SGO!13@\S~13!2@Abs.~2}.\footnote{Anderer Ansicht ist offenbar neuerdings das Bundesschiedsgericht, dem zufolge eine solche, dem \S~58~VwGO\index[paridx]{VwGO!58@\S~58} entsprechende Regelung, in der SGO nicht enthalten ist, \cite{BSGPP100132493}.}
