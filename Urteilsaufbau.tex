...
Gem. \S~12 Abs.~3 S.~1~SGO\indexPar{SGO!12@\S~12!3@Abs.~3} enthält ein Urteil \Zitat{einen Tenor, eine Sachverhaltsdarstellung und eine Begründung der Sach- und Rechtslage.}
...
Während gem. \S~11 Abs.~7~SGO\indexPar{SGO!11@\S~11!7@Abs.~7} lediglich die Dokumentationsvorschriften explizit auch für einstweilige Anordnungen gelten, ist es gängige Praxis, sämtliche Vorschriften über Urteile auf einstweilige Anordnungen sinngemäß anzuwenden.
...
\begin{itemize}
\item Name und Anschrift der Antragstellerin (vgl. auch \S~8 Abs.~3~SGO\indexPar{SGO!8@\S~8!3@Abs.~3}),
...
\item \Zitat{gegen},
\item Name und Anschrift der Antragsgegnerin (vgl. auch \S~8 Abs.~3~SGO\indexPar{SGO!8@\S~8!3@Abs.~3}),
...
Da die Verfahren vor den Schiedsgerichten der Piratenpartei immer kostenfrei sind (\S~16 Abs.~1 S.~1~SGO),\indexPar{SGO!16@\S~16!1@Abs.~1} kann eine Kostenentscheidung\index[idx]{Kosten!Entscheidung} entfallen.\footnote{Eine Kostenentscheidung muss auch auf expliziten Antrag einer Partei nicht getroffen werden, \cite{LSGNRW2016001HStreitwert}.}
...
Sind Rechtsmittel möglich, sind die Parteien darüber gesondert zu belehren (\S~13 Abs.~2 S.~3~SGO\indexPar{SGO!13@\S~13!2@Abs.~2}, siehe unten).
...
Gemäß \S~12 Abs.~3 S.~1~SGO\indexPar{SGO!12@\S~12!3@Abs.~3} enthält ein Urteil unter anderem eine Sachverhaltsdarstellung.
...
Gemäß \S~12 Abs.~4 S.~1~SGO\indexPar{SGO!12@\S~12!4@Abs.~4} haben die Richter \Zitat{das Recht, in der Urteilsbegründung eine abweichende Meinung zu äußern.}
Dieses Recht besitzt unter den staatlichen Gerichten der Bundesrepublik Deutschland lediglich die Verfassungsgerichtsbarkeit (vgl. z.B. \S~30 Abs.~2~BVerfGG\indexPar{BVerfGG!30@\S~30!2@Abs.~2}).
In der Piratenpartei steht es allen Richterinnen und Richtern zu, unabhängig von der Ebene ihres Schiedsgerichts.
Die Bestimmung zu solchen abweichenden Meinungen (auch als \enquote{Sondervotum}, plural \enquote{Sondervoten}, bezeichnet) stellt damit eine der eben dort genannten Ausnahmen zur ansonsten geltenden Regel, über \enquote{dienstliche} Vorgänge Stillschweigen zu bewahren (\S~2 Abs.~4~SGO\indexPar{SGO!2@\S~2!4@Abs.~4}), dar.\index[idx]{Verschwiegenheitspflicht}
...
Näheres zur abweichenden Meinung sollen die Schiedsgerichte in ihrer Geschäftsordnung regeln, \S~12 Abs.~4 S.~2~SGO\indexPar{SGO!12@\S~12!4@Abs.~4}.

\section{Die Rechtsmittelbelehrung}
\label{Urteilsaufbau:Rechtsmittelbelehrung}
\index[idx]{Rechtsmittelbelehrung}
Eine Rechtsmittelbelehrung soll gemäß \S~12 Abs.~5~SGO\indexPar{SGO!12@\S~12!5@Abs.~5} zumindest dann erfolgen, wenn gegen das Urteil die Berufung möglich ist.
...
Das Rechtsmittel ist unter Zitat der entsprechenden Norm anzugeben (bspw. die Berufung gemäß \S~13 Abs.~1~SGO\indexPar{SGO!13@\S~13!1@Abs.~1}).
...
Es reicht aus, die Parteien darüber zu belehren, dass die Berufungsfrist gemäß \S~13 Abs.~2 S.~1~SGO\indexPar{SGO!13@\S~13!2@Abs.~2} 14~Tage beträgt, sie muss nicht in einem genauen Datum angegeben werden.
...
Außer der Berufung kennt die Schiedsgerichtsordnung allerdings noch den \emph{Widerspruch}\index[idx]{Rechtsmittel!Widerspruch} gegen einstweilige Anordnung (\S~11 Abs.~4~SGO)\indexPar{SGO!11@\S~11!4@Abs.~4} und die \emph{sofortige Beschwerde}\index[idx]{Rechtsmittel!sofortige Beschwerde} gegen die Ablehnung einer einstweiligen Anordnung (\S~11 Abs.~6~SGO)\indexPar{SGO!11@\S~11!6@Abs.~6}, die Nichteröffnung (\S~8 Abs.~6 S.~3~SGO),\indexPar{SGO!8@\S~8!6@Abs.~6} Verzögerung (\S~10 Abs.~8 S.~1,~2~SGO)\indexPar{SGO!10@\S~10!9@Abs.~9} oder Aussetzung (in analoger Anwendung\footnote{\cite{BSGPP100222152}.}) eines Verfahrens, sowie den Nichtausschluss eines Richters vom Verfahren nach erfolgter Ablehnung (\S~5 Abs.~6 S.~2~SGO)\indexPar{SGO!5@\S~5!6@Abs.~6}.
...
Ist die Rechtsmittelbelehrung unterblieben, so beginnt die Rechtsmittelfrist nicht zu laufen, \S~13 Abs.~2 S.~3~SGO\indexPar{SGO!13@\S~13!2@Abs.~2}.\footnote{Anderer Ansicht ist offenbar neuerdings das Bundesschiedsgericht, dem zufolge eine solche, dem \S~58~VwGO\indexPar{VwGO!58@\S~58} entsprechende Regelung, in der SGO nicht enthalten ist, \cite{BSGPP100132493}.}
