...
In diesem Fall liegt kein Zugang mehr für die Streitpartei zur Parteischiedsgerichtsbarkeit mehr vor und deren Zuständigkeit endet damit.
...
In einem solchen Fall hat eine Streitpartei kein Rechtsschutzbedürfnis.\footnote{Vgl. hierzu etwa \cites{FGHE4K140613}{VFFFO7K62610}}
...
Entgegenstehende Rechtskraft liegt vor, wenn ein anderes Urteil zwischen diesen exakt diesen Streitparteien exakt die selbe Streitfrage schon entschieden hat.
Diese Frage ist wie alle Fragen Antragsweise zu entscheiden.
Wurde etwa der Antrag eines Mitglieds auf Aufhebung eines Beschlusses eines wegen dessen Rechtswidrigkeit schon einmal abgelehnt, kann das selbe Mitglied das nicht erneut in einem anderen Verfahren beantragen.
Dies dient der Verfahrensökonomik, damit Gericht nicht zugespammt werden.
Die Schiedsgerichtsordnung sieht eine Nichteröffnung wegen entgegenstehender Rechtskraft nicht vor, jedoch wird im Sinne der Verfahrensökonomik bei offensichtlich vorliegender entgegenstehender Rechtkraft auch ein direkter Nichteröffnungsbeschluss in analoger Anwendung von dessen Vorschriften möglich sein.
