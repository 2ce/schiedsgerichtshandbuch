...
% Widmung (Zitat)
%\togglecolumnmode			% Einspaltenlayout anschalten
...
%\togglecolumnmode		% Wieder ins Zweitspaltenlayout wechselns
...
%\appendix
\begin{appendices}
	\input{A_Schemata.tex}

	\input{A_Vorlagen.tex}
\end{appendices}
...
\markboth{Rechtsprechungsverzeichnis}{Rechtsprechungsverzeichnis}
